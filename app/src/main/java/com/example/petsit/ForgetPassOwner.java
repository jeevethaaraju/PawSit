...
public class ForgetPassOwner extends AppCompatActivity {
    ...
    private void sendResetCode() {
        ...
        String url = Constants.BASE_URL + "send_reset_code.php";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params),
                response -> {
                    try {
                        ...
                        Toast.makeText(ForgetPassOwner.this, message, Toast.LENGTH_SHORT).show();

                        if (success) {
                            // Switch to pin verification layout
                            setContentView(R.layout.forget_password_pin);
                            ImageView imageVector = findViewById(R.id.img_vector1);
                ...
                error -> {
                    Toast.makeText(ForgetPassOwner.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void verifyResetCode() {
        ...
        String url = Constants.BASE_URL + "verify_reset_code.php";
        Map<String, String> params = new HashMap<>();
        params.put("email", currentEmail);
