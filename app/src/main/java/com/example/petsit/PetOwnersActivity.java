...
public class PetOwnersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noPetOwnersText = findViewById(R.id.text_no_petowner);
    ...
    private void loadPetOwners() {
        String url = Constants.BASE_URL + "view_petowners.php"; // Replace with your actual URL
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(PetOwnersActivity.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PetOwnersActivity.this, "Error loading data", Toast.LENGTH_SHORT).show();
                        noPetOwnersText.setVisibility(View.VISIBLE);
                        recyclerView.setVisibility(View.GONE);
                    }
                }
    ...
    private class PetOwnerAdapter extends RecyclerView.Adapter<PetOwnerAdapter.PetOwnerViewHolder> {
        ...
        public PetOwnerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_petowner_order, parent, false);
...
ImageView profileImage;
            public PetOwnerViewHolder(@NonNull View itemView) {
                ...
                textId = itemView.findViewById(R.id.text_petowner_id);
